...
export default function Login() {
  return (
    <div className="flex flex-row">
      <div className="flex items-end h-screen w-[50%] p-12 bg-borrowDark text-white text-3xl font-nunito font-thin">
        <h1>
          Transforme sua paixão por <span className="text-pink">leitura</span>{' '}
          em uma <span className="text-pink">competição</span> divertida!
        </h1>
      </div>
      <div className="flex flex-col items-center justify-center w-[50%] bg-white h-screen p-40">
        <div className="flex flex-row w-full items-center justify-center gap-2">
          <Image src={Worm} alt="Worm" width={80} height={80} />
          <h1 className="font-sacramento text-borrow text-6xl">bookworms</h1>
        </div>
        <div className="flex-col h-full w-full space-y-4">
          <TextInput type="email" placeholder="m@example.com" label="Email" />
